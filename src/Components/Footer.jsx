          ...
          <div className="flex flex-wrap justify-between gap-12 md:gap-6">
            <div className="max-w-80">
              <img
                src={assets.logo}
                alt="logo"
                className="invert opacity-80 mb-4 h-8 md:h-9 cursor-pointer"
              />
              <p className="text-sm">
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <a href="#">
                  ...
                  <img
                    ...
                    alt="instagramIcon cursor-pointer"
                  />
                </a>
                {/* Facebook */}
                <a href="#">
                  <img
                    ...
                    alt="facebookIcon cursor-pointer"
                    className="w-6"
                  />
                </a>
                {/* Twitter */}
                <a href="#">
                  <img
                    ...
                    alt="twitterIcon cursor-pointer"
                    className="w-6"
                  />
                </a>
                {/* LinkedIn */}
