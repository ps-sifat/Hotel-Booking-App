        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!booking.isPaid && (
                <button className="px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-200 hover:-translate-y-1 transition-all cursor-pointer ease-in ">
                  Pay Now
                </button>
              )}
            </div>
